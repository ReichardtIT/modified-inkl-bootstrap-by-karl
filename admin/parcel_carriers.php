              ...
              <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td valign="top">
                    ...
                    <div class="smallText pdg2 flt-l" style="padding: 5px 2px; float: left;"><?php echo $carriers_split->display_count($carriers_query_numrows, '20', $page_parcel, TEXT_DISPLAY_NUMBER_OF_CARRIERS); ?></div>
                    <div class="smallText pdg2 flt-r" style="padding: 5px 2px; float: right;"><?php echo $carriers_split->display_links($carriers_query_numrows, '20', MAX_DISPLAY_PAGE_LINKS, $page_parcel); ?></div>

                    <?php
                    if (empty($action)) {
                    ?>
                    <div class="clear" style="clear: both;"></div>
                    <div class="pdg2 flt-r smallText" style="padding: 5px 2px; float: right;"><?php echo '<a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_PARCEL_CARRIERS, 'page=' . $page_parcel . '&action=new') . '">' . BUTTON_NEW_CARRIER . '</a>'; ?></div>
                    <?php
                    }
                    ?>
                    <div class="clear" style="clear: both;"></div>
                    <br/>
                    <div class="pdg2 customers-groups smallText" style="width:100%;" style="padding: 5px 2px;"><?php echo TEXT_CARRIER_LINK_DESCRIPTION; ?></div>
                  </td>
                  <?php
                  $heading = array();
                  $contents = array();
